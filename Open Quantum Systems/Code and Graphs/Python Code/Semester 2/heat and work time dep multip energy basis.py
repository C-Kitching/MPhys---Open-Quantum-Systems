...
if __name__ == '__main__':
    ...
    # energy populations
    plt.figure()
    plt.plot(time, minus_avg, label = '$\\rho_{--}$')
    plt.plot(time, plus_avg, label = '$\\rho_{++}$')
    plt.xlabel('$\\frac{t}{t_{max}}$')
    plt.ylabel('$\overline{P}$')
    plt.title('Energy-basis populations')
    plt.legend()
    
    #spin populations
    plt.figure()
    plt.plot(time, up_avg, label = '$\\rho_{ee}$')
    plt.plot(time, down_avg, label = '$\\rho_{gg}$')
    plt.xlabel('$\\frac{t}{t_{max}}$')
    plt.ylabel('$\overline{P}$')
    plt.title('Spin-state populations')
    plt.legend()
    
    # cummulative graph
    plt.figure()
    #plt.plot(time, cum_energy, label = 'Energy')
    plt.plot(time, cum_work, label = 'Work')
    plt.plot(time, cum_heat, label = 'Heat')
    plt.legend()
    plt.xlabel('$\\frac{t}{t_{max}}$')
    plt.ylabel('Energy scale')
    plt.title('Cummulative change in heat and work')
