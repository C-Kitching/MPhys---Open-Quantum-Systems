...
# populations
plt.figure()
plt.plot(time, spin_up, label = '$\\rho_{ee}$') 
plt.plot(time, spin_down, label = '$\\rho_{gg}$') 
plt.legend()
plt.xlabel('$\\frac{t}{t_{max}}$')
plt.ylabel('$\overline{P}$')
plt.title('spin-state population')

# populations
plt.figure()
plt.plot(time, plus_pop, label = '$\\rho_{++}$') 
plt.plot(time, minus_pop, label = '$\\rho_{--}$') 
plt.legend()
plt.xlabel('$\\frac{t}{t_{max}}$')
plt.ylabel('$\overline{P}$')
plt.title('Energy-state populations')

# cummulative graph
plt.figure()
plt.plot(time, cum_work, label = 'Work')
plt.plot(time, cum_heat, label = 'Heat')
#plt.plot(time, cum_energy, label = 'cumm energy')
plt.legend()
plt.xlabel('$\\frac{t}{t_{max}}$')
plt.ylabel('Normalised energy scale')
plt.title('Cummulative heat and work')
