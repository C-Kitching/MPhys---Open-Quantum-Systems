...
for i in range(number_of_traj):
    multiple_traj_excited_pop.append(single_MC(initial_state, t)[1])
    multiple_traj_ground_pop.append(single_MC(initial_state, t)[0])
...
# Graph details
plt.title('Fast time-dependent bias in energy basis \nfor %d trajectories' %number_of_traj)
