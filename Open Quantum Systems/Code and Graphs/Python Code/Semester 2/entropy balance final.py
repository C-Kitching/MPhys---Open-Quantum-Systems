...
if __name__ == '__main__':
    ...
    plt.plot(np.log(regime), master_S, label = r'$|\hspace{0.1}\frac{dS}{dt}\hspace{0.1}|$')
    ...
    plt.plot(np.log(regime), master_J, label = r'$|\hspace{0.1}J\hspace{0.1}|$')
    plt.xlabel(r'$log(t_{max})$', fontsize = 14)
    plt.ylabel('Normalised entropy scale', fontsize = 14)
    plt.legend(fontsize = 14)
